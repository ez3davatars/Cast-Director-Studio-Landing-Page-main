      ...
      <div className="mx-auto max-w-[1280px] relative z-10" ref={revealRef}>
          ...
          <div className="xl:col-span-5" data-reveal="left">
            <div className="flex flex-col gap-3 mb-5">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-nano-yellow">
                From Character Idea to Production Pipeline
              </span>
            </div>
            <h2 className="text-3xl font-display font-bold tracking-tight text-white md:text-[42px] leading-[1.1]">
              One Actor. Many Looks. A Faster Creative Pipeline.
            </h2>
            <div className="mt-5 space-y-4 text-[17px] leading-relaxed text-slate-300">
              <p>
                Create a reusable digital actor, then guide that actor across different visual directions without rebuilding the character from the ground up.
              </p>
              <p>
                Start with quick style presets when you want speed, then keep directing the look with wardrobe, props, lighting, scene composition, and reference-based controls.
              </p>
              <p>
                From realistic spokespeople to stylized mascots, sci-fi leads, illustrated actors, anime-inspired cast members and more, Cast Director Studio brings characters, wardrobe direction, props, and lighting control into one streamlined production pipeline — helping creators move from concept to polished visual assets faster.
              </p>
            </div>
          </div>
          ...
          <div className="xl:col-span-7" data-reveal="right">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:row-span-2 rounded-[28px] flex flex-col justify-center min-h-[300px] p-8 bg-gradient-to-br from-amber-950/40 via-amber-900/20 to-transparent border border-amber-500/10 shadow-lg group transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/20 relative overflow-hidden">
                ...
                <span className="font-display font-bold text-white text-[22px] leading-snug relative z-10">Create the actor once. Reuse the creative foundation across many looks.</span>
              </div>
              ...
              <div className="rounded-[20px] p-6 flex flex-col justify-center gap-3 transition-all duration-300 hover:-translate-y-1 bg-white/[0.02] border border-white/[0.06] hover:border-nano-yellow/20 border-l-2 border-l-slate-500/30">
                <span className="font-semibold text-white text-[15.5px] leading-snug">Keep wardrobe, props, lighting, and character direction connected across outputs.</span>
              </div>

              {/* Medium Chip 2 */}
              <div className="rounded-[20px] p-6 flex flex-col justify-center gap-3 transition-all duration-300 hover:-translate-y-1 bg-white/[0.02] border border-white/[0.06] hover:border-nano-yellow/20 border-l-2 border-l-slate-500/30">
                <span className="font-semibold text-white text-[15.5px] leading-snug">Move from concept to usable production assets without starting over each time.</span>
              </div>

              {/* Status Row */}
              <div className="sm:col-span-2 py-2.5 px-4 flex items-center gap-3 border-b border-white/[0.04]">
                <div className="w-1.5 h-1.5 rounded-full bg-slate-500" />
                <span className="font-medium text-slate-400 text-[15px]">Style presets help you start fast. Directed controls help you keep production moving.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 lg:mt-10 glass-panel-premium rounded-[28px] p-1.5 relative overflow-hidden group transition-transform duration-300 hover:-translate-y-1" data-reveal="up">
          <div className="relative rounded-[22px] overflow-hidden">
            <img
              src="/multi-style.png"
              alt="Same character rendered across realism, stylized, illustration, sci-fi, and anime art styles — example preset range, not the app's full limit"

...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center py-20 overflow-hidden bg-nano-dark">
      ...
      <div className="container mx-auto px-6 z-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-xl text-nano-text max-w-lg leading-relaxed border-l-2 border-nano-yellow pl-6">
            ...
            <br />
            <span className="text-white font-medium">Turn a single user into a full film crew or photography studio:</span> Casting Director, Costume Designer, and Cinematographer.
          </p>
